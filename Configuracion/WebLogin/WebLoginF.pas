...
type
  TWebLoginForm = class(TForm)
    ...
    procedure ContraseñaEditExit(Sender: TObject);
...
procedure TWebLoginForm.ContraseñaEditExit(Sender: TObject);
begin
  webPsw := ContraseñaEdit.Text;
end;
...
begin
  ...
  begin
    ...
    try
      webUsr := CUIT;
      UsuarioEdit.Text := webUsr;
      webPsw := DM.GenerarContraseña(Fecha + Empresa + PuntoVenta + Titular + CUIT);
      ContraseñaEdit.Text := webPsw;
      DMR.WebPago;
    finally
      DM.EscribirINI;
    ...
    try
        begin
          ...
          begin
            ...
            else ShowMessage('Sesión iniciada correctamente');
          end;
        end;
    finally
      DMR.Free;
